...
1. [Number Frequency Counter](#1-number-frequency-counter)
2. [Rock Paper Scissors Game](#2-rock-paper-scissors-game)
3. [CLI To-Do List Manager](#3-cli-to-do-list-manager)
4. [Unique Elements Collector](#4-unique-elements-collector)
